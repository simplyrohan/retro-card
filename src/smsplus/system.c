...
{
  option_sms.sndrate      = 48000;
  option_sms.country      = 0;
  option_sms.console      = 0;
  option_sms.fm           = SND_NONE;
  option_sms.overscan     = 1;
  option_sms.xshift       = 0;
  option_sms.yshift       = 0;
  option_sms.xscale       = 0;
  option_sms.yscale       = 0;
  ...
  option_sms.render       = 0;
  option_sms.ntsc         = 0;
  option_sms.tv_mode      = 0;
  option_sms.sms_pal      = 1;
  option_sms.tms_pal      = 0;
  option_sms.spritelimit  = 1;
